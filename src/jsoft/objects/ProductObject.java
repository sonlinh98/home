...
public class ProductObject {
	...
	public byte getProduct_pg_id() {
		return product_pg_id;
	}
	public byte getProduct_ps_id() {
	...
	public void setProduct_pg_id(byte product_pg_id) {
		this.product_pg_id = product_pg_id;
	}
	public void setProduct_ps_id(byte product_ps_id) {
